...
variable "key_pair_name" {
  description = "EC2 Key Pair name for SSH access. Leave null to use the key pair auto-generated by the 00-vpc layer."
  type        = string
  default     = null
}
...
# -----------------------------------------------------------------------------
variable "subnet_ids" {
  description = "Unused — backend subnet is sourced from the 00-vpc remote state. Kept for module compatibility."
  type        = list(string)
  default     = []
}
